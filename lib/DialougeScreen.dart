...
class DialougeScreen extends StatefulWidget
{
  const DialougeScreen({Key? key}) : super(key: key);

  @override
  State<DialougeScreen> createState() => _DialougeScreenState();
}

class _DialougeScreenState extends State<DialougeScreen> {
