...
class TeacherDialougeScreen extends StatefulWidget
{
  const TeacherDialougeScreen({Key? key}) : super(key: key);

  @override
  State<TeacherDialougeScreen> createState() => TeacherDialougeScreenState();
}

class TeacherDialougeScreenState extends State<TeacherDialougeScreen> {
