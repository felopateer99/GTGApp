...
import 'package:gtgapplication/TeacherDialougeScreen.dart';
import 'package:gtgapplication/TeacherGrammerScreen.dart';
import 'package:gtgapplication/TeacherHomeScreen.dart';
import 'package:gtgapplication/TeacherHomeworkScreen.dart';
import 'package:gtgapplication/TeacherVocabScreen.dart';
...
class Tunit2 extends StatefulWidget
{
  const Tunit2({Key? key}) : super(key: key);

  @override
  State<Tunit2> createState() => _Tunit2State();
}

class _Tunit2State extends State<Tunit2> {
                  ...
                  Container(
                      ...
                      child: MaterialButton(onPressed: (){
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => TeacherVocabScreen()
                          ),
                        );
                      },
                  ...
                  Container(
                      ...
                      child: MaterialButton(onPressed: (){
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => TeacherGrammerScreen()
                          ),
                        );
                      },
                        child: Text('Grammer',
                  ...
                  Container(
                      ...
                      child: MaterialButton(onPressed: (){
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => TeacherDialougeScreen()
                          ),
                        );
                      },
                        child: Text('Dialouge',
                  ...
                  Container(
                      ...
                      child: MaterialButton(onPressed: (){
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => TeacherHomeworkScreen()
                          ),
                        );
                      },
                        child: Text('Homework',
