...
class StudentQuizScreen extends StatefulWidget
{
  ...
  @override
  State<StudentQuizScreen> createState() => StudentQuizScreenState();
}

class StudentQuizScreenState extends State<StudentQuizScreen> {
                ...
                children: [
                  ...
                  Container(
                    ...
                    child:MaterialButton(onPressed: () async {
                      const url = 'https://forms.gle/rtTgcipdaQ7Dof8E6';
